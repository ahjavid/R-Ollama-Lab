...
pull("gemma3n:e4b")         # Best for complex reasoning
...
| `gemma3n:e4b` | 6.0GB | Study design, reasoning | ⚡⚡ |
...
# Query function
ask_expert <- function(question, model = "gemma3n:e4b") {
...
generate_code <- function(prompt, model = "qwen2.5-coder:7b", num_predict = 2000) {
  generate(
    model,
    prompt,
...
# Step 1: Get approach
step1 <- chat("gemma3n:e4b", conv, output = "text")
cat("=== APPROACH ===\n", step1, "\n\n")
...
step2 <- chat("gemma3n:e4b", conv, output = "text")
cat("=== DETAILED PLAN ===\n", step2, "\n\n")
...
get_consensus <- function(question, models = c("gemma3n:e4b", "qwen2.5-coder:7b")) {
...
advice1 <- ask_expert("...", "gemma3n:e4b")
...
# Example usage
generate("qwen2.5-coder:7b", "...", temperature = 0.2, num_predict = 2000, output = "text")
```
