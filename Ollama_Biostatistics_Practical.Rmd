...
# generate(..., temperature = 0.2, top_p = 0.3, num_predict = 1500)

# Reasoning: moderate temperature
# generate(..., temperature = 0.4, top_p = 0.5, num_predict = 1000)

# Creative: higher temperature
# generate(..., temperature = 0.6, top_p = 0.7, num_predict = 1200)

# Example usage
generate("qwen2.5-coder:7b", "...", temperature = 0.2, num_predict = 1500, output = "text")
```
