...
/* LLM Header Styles (prevent section numbering) */
.llm-h1 {
  font-size: 1.4em;
  color: #2b6cb0;
...
<div class="hero-box">
<h2>🧬 Bring AI to Your Biostatistics Workflow</h2>
<p>This guide demonstrates how to use <strong>local Large Language Models</strong> (via Ollama) for statistical consulting, code generation, and analysis design—all running privately on your machine.</p>

**What you'll learn:**

- ✅ Statistical consultation with AI experts
- ✅ Automated R code generation for complex analyses
- ✅ Iterative analysis design workflows
- ✅ Semantic literature search with embeddings
- ✅ Structured outputs for reproducible reports
</div>

<div class="info-box">
**📋 Quick Reference:** Jump to any section using the floating table of contents on the left.
</div>
...
<div class="tip-box">
**💡 Pro Tip:** Each pattern below can be combined. Start with consultation (Pattern 1), then generate code (Pattern 2), and iterate to refine (Pattern 3).
</div>
...
expert_prompt <- "You are a senior biostatistician. Give concise, evidence-based recommendations with key assumptions. Use markdown formatting but avoid using # headers."
...
sanitize_llm_output <- function(text) {
  # Convert markdown headers to bold styled paragraphs
  # #### Header -> <p class='llm-h4'><strong>Header</strong></p>
  text <- gsub("^####\\s*(.+)$", "<p class='llm-h4'><strong>\\1</strong></p>", text, perl = TRUE)
  text <- gsub("\n####\\s*(.+)", "\n<p class='llm-h4'><strong>\\1</strong></p>", text, perl = TRUE)
  # ### Header -> <p class='llm-h3'><strong>Header</strong></p>
  text <- gsub("^###\\s*(.+)$", "<p class='llm-h3'><strong>\\1</strong></p>", text, perl = TRUE)
  text <- gsub("\n###\\s*(.+)", "\n<p class='llm-h3'><strong>\\1</strong></p>", text, perl = TRUE)
  # ## Header -> <p class='llm-h2'><strong>Header</strong></p>
  text <- gsub("^##\\s*(.+)$", "<p class='llm-h2'><strong>\\1</strong></p>", text, perl = TRUE)
  text <- gsub("\n##\\s*(.+)", "\n<p class='llm-h2'><strong>\\1</strong></p>", text, perl = TRUE)
  # # Header -> <p class='llm-h1'><strong>Header</strong></p>
  text <- gsub("^#\\s*(.+)$", "<p class='llm-h1'><strong>\\1</strong></p>", text, perl = TRUE)
  text <- gsub("\n#\\s*(.+)", "\n<p class='llm-h1'><strong>\\1</strong></p>", text, perl = TRUE)
  return(text)
}
...
cat("\n<p class='llm-h2'><strong>📋 Analysis Approach</strong></p>\n\n<div class='llm-output'>\n\n")
...
cat("\n<p class='llm-h2'><strong>📊 Detailed Plan</strong></p>\n\n<div class='llm-output'>\n\n")
...
cat("\n<p class='llm-h2'><strong>💻 Generated Code</strong></p>\n\n<div class='llm-output'>\n\n")
...
<div class="info-box">
**🎯 Real-World Scenarios:** These examples mirror common biostatistics tasks in clinical trials and observational studies. Each generates complete, runnable R code.
</div>
...
**⚠️ Performance Note:** Parallel requests can speed up batch queries significantly, but monitor your system resources. Ollama loads models into GPU/RAM, so running too many concurrent requests may cause memory issues.
</div>
...
<div class="tip-box">
**🔬 Hands-On Demo:** This section uses R's built-in `mtcars` dataset to demonstrate a complete LLM-assisted analysis workflow from exploratory analysis to interpretation.
</div>
...
cat("\n<p class='llm-h2'><strong>📊 Analysis Plan</strong></p>\n")
...
cat("\n<p class='llm-h2'><strong>💻 Generated R Code</strong></p>\n")
...
cat("\n<p class='llm-h2'><strong>📋 Step 1: Design Consultation</strong></p>\n")
design <- ask_expert("
...
cat("\n<p class='llm-h2'><strong>💻 Step 2: Analysis Code</strong></p>\n")
...
cat("\n<p class='llm-h2'><strong>📝 Step 3: Report Template</strong></p>\n")
generate_code("
...
<div class="info-box">
**📚 Learn More:** Explore these resources to deepen your understanding of local LLMs and biostatistics with R.
</div>
...
<h3 style="color: white; margin: 0;">🎉 Thank You for Exploring!</h3>
