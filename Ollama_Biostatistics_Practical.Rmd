...
# Query function
ask_expert <- function(question, model = "gemma3:12b") {
...
# Note: avoid stop sequences when generating code with markdown formatting
generate_code <- function(prompt, model = "qwen3:14b", num_predict = 2000) {
  generate(
    model,
    prompt,
...
# Access fields from the structured response
...
```{r real-data-example, eval=run_llm}
...
analysis_plan <- ask_expert(paste0(data_summary, "
...
analysis_code <- generate_code(paste0(data_summary, "
